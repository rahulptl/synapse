...
echo -e "${BLUE}================================================${NC}"
echo -e "${BLUE}  Synapse Backend - Production Deployment${NC}"
echo -e "${BLUE}================================================${NC}"
echo ""
...
gcloud run deploy ${SERVICE_NAME} \
  ...
  --set-env-vars "DATABASE_URL=postgresql+asyncpg://prod_user:YOUR_PROD_PASSWORD@/prod" \
...
echo -e "  4. Monitor service: https://console.cloud.google.com/run/detail/${REGION}/${SERVICE_NAME}/metrics"
echo ""
