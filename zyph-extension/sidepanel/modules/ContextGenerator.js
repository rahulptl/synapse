...
window.MemoryBay.ContextGenerator = class ContextGenerator {
    ...
    createFormattedPrompt(folder, folderContent) {
        ...
        let prompt = `# Memory Bay: ${folder.name}\n`;
        ...
        prompt += `## About This Memory Bay\n\n`;
        prompt += `This comprehensive memory bay contains all essential information about **${folder.name}**. `;
        ...
        prompt += `**Purpose:** This memory bay serves as a complete reference that enables anyone to quickly understand the background, current status, key players, and important details related to ${folder.name}. Perfect for onboarding, research, or as context for AI assistance.\n\n`;
        ...
        prompt += `*Generated by Memory Bay Extension - Intelligent Web Content Organization*`;
